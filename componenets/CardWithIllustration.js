        ...
        <Stack align={"center"} spacing={2}>
          ...
          <center>
            <Text fontSize={"lg"} color={"gray.500"}>
              Subscribe to our newsletter for daily reminders <br /> to do some
              exercise when checking your email! <br />{" "}
              <Text color={"blue"}>
                This email service has ended but feel free to contact <br />
                defaccsuport@gmail.com if you want <br /> this email service to
                continue.
              </Text>
            </Text>
          </center>
